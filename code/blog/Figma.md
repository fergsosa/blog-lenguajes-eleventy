...
- **Figma** es una herramienta de diseño basada en la nube, accesible desde cualquier navegador o aplicación de escritorio.
- A diferencia de otros programas como **Sketch** (exclusivo de macOS) o **Adobe XD** (requiere instalación y licencia), Figma es **multiplataforma, colaborativo en tiempo real y gratuito en su versión básica**.
- Su **fortaleza principal** es la colaboración: varios usuarios pueden trabajar en el mismo archivo sin necesidad de sincronización manual.

### 2. ¿Para qué se usa?

- **Diseño de interfaces (UI/UX)** para aplicaciones web y móviles.
- **Creación de prototipos interactivos** que simulan la navegación real de una app.
- **Documentación de estilos y sistemas de diseño** que luego serán implementados en código.
- **Comunicación entre diseñadores y programadores**, evitando malentendidos.
- Contextos más comunes: equipos de desarrollo ágil, startups, proyectos colaborativos y productos digitales con constante iteración.

### 3. ¿Qué puedo construir con {{title}}?

- **Wireframes**:\
  bocetos estructurales de interfaces.
- **Mockups de alta fidelidad**:\
  diseños detallados que se parecen al producto final.
- **Prototipos navegables**:\
  flujos completos de interacción.
- **Design Systems**:\
  bibliotecas reutilizables de componentes (botones, inputs, layouts).
- **Guías de estilo exportables**\
  que los programadores pueden traducir a código.

### 4. ¿Cuándo es más conveniente usarlo?

- Cuando se requiere **trabajo colaborativo en tiempo real**.
- Si el proyecto necesita **iteraciones rápidas y feedback constante**.
- En equipos donde no todos tienen acceso a licencias de software de diseño costoso.
- Para documentar y alinear diseño con desarrollo sin depender de exportaciones manuales.
...
- **Usar nombres consistentes**\
  en capas, componentes y páginas.
- **Agrupar y anidar elementos**\
  de forma lógica, evitando estructuras caóticas.
- **Construir componentes reutilizables**\
  (botones, cards, menús) para evitar duplicación.
- **Definir estilos globales**\
  (colores, tipografías, efectos) en lugar de aplicarlos de forma aislada.
- **Documentar interacciones**\
  y estados (hover, focus, disabled) tal como se haría en el código.
- **Aplicar principios de modularidad**\
  tal como en programación, para que los cambios sean escalables.
...
- Cuando se necesita trabajar sin conexión de forma prolongada
...
- **Design to Code:**\
  genera fragmentos en HTML, CSS o React a partir del diseño.
- **Figmoji / Iconify:**\
  acceso a íconos directamente en el entorno.
- **Themer:**\
  gestiona tokens de diseño y temas dinámicos.

### Integraciones con repositorios y proyectos:

- Conexión con **GitHub**, **Jira** o **Notion** para mantener trazabilidad entre tareas y diseños.
- Plugins de exportación hacia frameworks como **Tailwind CSS** o **React**.
...
- **Grupo:**\
  solo organiza elementos visualmente sin propiedades especiales.
- **Frame:**\
  es una estructura con propiedades propias (layout, constraints, auto layout), lo que lo hace más flexible y controlable en diseño responsivo.
...
- **Prototipo estático:** solo muestra la interfaz visual sin interacción.
- **Prototipo interactivo:** conecta pantallas con enlaces, transiciones y animaciones, simulando la navegación real de la aplicación.

### 10. ¿Cómo exportarías un set de íconos desde Figma para utilizarlos en un proyecto web en React?

- Selecciono los íconos en SVG.
- Los exporto en formato **SVG optimizado**.
- Los importo en React como componentes (`import {ReactComponent as Icon} from './icon.svg';`).
- Opcional: centralizo los íconos en una librería propia para mayor reutilización.
...
- Seguir una **convención clara** (ej: `btn/primary`, `card/header`).
- Usar jerarquías y prefijos.
- Nombrar de forma **descriptiva y corta**.
- Evitar duplicados o nombres genéricos como "Frame 1" o "Group 2".

### 13. ¿Cómo manejarías el versionado de un archivo de Figma en un equipo con múltiples diseñadores y desarrolladores?

- Usar **ramas (branches)** en Figma para experimentar sin afectar el archivo principal.
- Definir **checkpoints de versión**.
- Documentar cambios relevantes antes de publicar.
- Integrar con herramientas como Jira o Notion para trazabilidad.
